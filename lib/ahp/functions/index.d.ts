...
export { createComparisonTable, createTable, decide, getAttributesInfo, getConsistency, getConsistencyIndex, getConsistencyRatio, getFinalPriorities, getLambdaMax, getSaatyScaleScore, ponderation, priorityByItem, serializeData, sumColumns, };
