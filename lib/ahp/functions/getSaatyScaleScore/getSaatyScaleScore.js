 ...
 */
function getSaatyScaleScore(greatestDif, op1Value, op2Value, betterWhen) {
    var saatyScale = [1, 3, 5, 7, 9];
    var num = op1Value > op2Value ? op1Value - op2Value : op2Value - op1Value;
    var score = (num * 9) / greatestDif;
    var saatyScaleScore = 1;
    saatyScale.forEach(function (item, i) {
        if (score > item) {
...
exports["default"] = getSaatyScaleScore;
