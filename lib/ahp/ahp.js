...
function ahp(data, humanInput) {
    ...
    var ponderationInfo = (0, functions_1.ponderation)(humanInput.attributesPrioritiesTable, humanInput.attributes.map(function (attr) { return attr.name; }), 'ponderacao');
